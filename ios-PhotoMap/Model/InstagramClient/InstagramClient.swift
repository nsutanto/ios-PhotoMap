...
class InstagramClient {
    ...
    private func downloadImage(imageURL: String, completionHandler: @escaping(_ imageData: Data?, _ error: NSError?) ->  Void) -> URLSessionTask {
    ...
    private func parseURLFromParameters(_ parameters: [String:AnyObject]?, withPathExtension: String? = nil) -> URL {
        ...
        components.path = Constants.API_PATH + (withPathExtension ?? "")
